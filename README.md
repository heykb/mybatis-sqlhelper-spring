...
## 原理
使用druid sql parse注入sql,通过Mybatis拦截器替换执行sql。
...
### 2.注入bean。
注入租户信息获取bean,继承[TenantInfoHandler](src/main/java/io/github/heykb/sqlhelper/handler/abstractor/TenantInfoHandler.java)，如：
~~~java
@Component
